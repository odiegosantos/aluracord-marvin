          ...
          >
            <TextField
              ...
              styleSheet={{
                ...
                borderRadius: '5px',
                padding: '6px 8px',
                backgroundColor: appConfig.theme.colors.MyColors['BgButtonColor'],
                marginRight: '12px',
        ...
        return (
          <Text
            ...
            styleSheet={{
              ...
              marginBottom: '12px',
              hover: {
                backgroundColor: appConfig.theme.colors.MyColors['BgButtonColorHover'],
              }
            }}
          >
            <Box
            ...
            >
              <Image
                ...
                src={`https://github.com/odiegosantos.png`}
              />
              <Text tag="strong">
                {mensagem.de}
              </Text>
